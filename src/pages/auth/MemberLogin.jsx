...
export default function MemberLogin() {
  ...
  const handleLogin = async (e) => {
    e.preventDefault();
    setError('');
    if (!form.username || !form.phone) { setError('Username dan nomor HP wajib diisi.'); return; }
  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-col justify-center items-center w-full lg:w-[48%] bg-[#FAF7F2] px-8 sm:px-14 py-12 z-10">
        ...
        >
          <div className="w-7 h-7 bg-[#C67C4E] rounded-lg flex items-center justify-center text-white font-black text-xs shadow-md shadow-[#C67C4E]/20">B</div>
